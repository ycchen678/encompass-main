...
def test_find_closest_location_1():
    point = {
        'id': 1,
        'latitude': 38.74753421600008,
        'longitude': -123.2316317029999,
    }
    locations = [
        Point(**{'latitude': 37.74753421600008, 'longitude': -122.2316317029999}),
        Point(**{'latitude': 32.74753421600008, 'longitude': -122.2316317029999}),
    ...
    expected = {
        'id': point['id'],
        'closest_point': Point(latitude=38.74753421600008, longitude=-123.2316317029999),
        'to_closest_provider': 0
    }

    assert output == expected

def test_calculate_adequacies_2():
